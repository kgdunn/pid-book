...
bitmap('/Users/kevindunn/Statistics course/Course notes/Correlation, covariance and least squares/images/influence-of-outliers-slides.png', type="png256", width=16, height=16/2, res=300, pointsize=14)
...
# bitmap('/Users/kevindunn/Statistics course/Course notes/Correlation, covariance and least squares/images/influence-of-outliers-slide3.png', type="png256", width=7, height=7, res=300, pointsize=14)
...
bitmap('/Users/kevindunn/Statistics course/Course notes/Correlation, covariance and least squares/images/hatvalue-of-outliers-slides.png', type="png256", width=16, height=16/2, res=300, pointsize=14)
layout(matrix(c(1,2), 1, 2))
par(mar=c(4.2, 5, 1.5, 0.5))  # (bottom, left, top, right); defaults are par(mar=c(5, 4, 4, 2) + 0.1)
par(cex.lab=1.7, cex.main=1.8, cex.sub=1.8, cex.axis=1.8)
...
bitmap('/Users/kevindunn/Statistics course/Course notes/Correlation, covariance and least squares/images/studentized-residuals-slides.png', type="png256", width=16, height=16/3, res=300, pointsize=14)
layout(matrix(c(1,2,3), 1, 3))
par(mar=c(4.2, 5, 1.5, 0.5))  # (bottom, left, top, right); defaults are par(mar=c(5, 4, 4, 2) + 0.1)
par(cex.lab=1.7, cex.main=1.8, cex.sub=1.8, cex.axis=1.8)
...
bitmap('/Users/kevindunn/Statistics course/Course notes/Correlation, covariance and least squares/images/cooks-distances-slides.png', type="png256", width=16, height=16/3, res=300, pointsize=14)
layout(matrix(c(1,2,3), 1, 3))
par(mar=c(4.2, 5, 1.5, 0.5))  # (bottom, left, top, right); defaults are par(mar=c(5, 4, 4, 2) + 0.1)
par(cex.lab=1.7, cex.main=1.8, cex.sub=1.8, cex.axis=1.8)
...
library(car)
bitmap('/Users/kevindunn/Statistics course/Course notes/Correlation, covariance and least squares/images/influence-plots-slides.png', type="png256", width=16, height=16/3, res=300, pointsize=14)
layout(matrix(c(1,2,3), 1, 3))
par(mar=c(4.2, 5, 1.5, 0.5))  # (bottom, left, top, right); defaults are par(mar=c(5, 4, 4, 2) + 0.1)
par(cex.lab=1.7, cex.main=1.8, cex.sub=1.8, cex.axis=1.8)
