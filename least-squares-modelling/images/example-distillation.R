...
bitmap('/Users/kevindunn/Statistics course/Course notes/Correlation, covariance and least squares/images/residual-plots.png', type="png256", width=14, height=7, res=300, pointsize=14)
