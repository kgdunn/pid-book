...
[![Download PDF](https://img.shields.io/badge/download-PDF-red.svg)](https://learnche.org/pid/PID.pdf?2026-05-18)
...
> grab the **[PDF](https://learnche.org/pid/PID.pdf?2026-05-18)**. This repository is for
...
| `make latexpdf` | Build the PDF (5–10 minutes; needs LaTeX). Output: `_build/latex/PID.pdf?2026-05-18` |
...
Compare your PDF against <https://learnche.org/pid/PID.pdf?2026-05-18> to confirm a
clean build.
...
3. **Build.** `uv` resolves the Python toolchain (see Prerequisites above),
   ...
   `_build/html/` (extensionless static pages), `_build/latex/PID.pdf?2026-05-18`
...
5. **CI/CD.**
   ...
   only, it then rsyncs `_build/html/` and `_build/latex/PID.pdf?2026-05-18` over SSH to
