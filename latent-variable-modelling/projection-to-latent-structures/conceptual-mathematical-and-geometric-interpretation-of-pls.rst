...
The above is a description of one variant of PLS, `known as SIMPLS <https://literature.learnche.org/item/79/simpls-an-alternative-approach-to-partial-least-squares-regression>`_ (simple PLS).
