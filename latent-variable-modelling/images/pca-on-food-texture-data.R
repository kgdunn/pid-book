...
bitmap('pca-on-food-texture-scatterplot-matrix.png', type="png256", width=14, height=9, res=300, pointsize=14)
library(car)
...
bitmap('pca-on-food-texture-centering-and-scaling.png', type="png256", width=14, height=5, res=300, pointsize=14)
...
bitmap('pca-on-food-texture-pc1-loadings.png', type="png256", width=10, height=5, res=300, pointsize=14)
par(cex.lab=1.5, cex.main=1.8, cex.sub=1.8, cex.axis=1.8)
...
bitmap('pca-on-food-texture-pc2-loadings.png', type="png256", width=10, height=5.5, res=300, pointsize=14)
par(cex.lab=1.5, cex.main=1.8, cex.sub=1.8, cex.axis=1.8)
...
# Joint loadings plot:
bitmap('pca-on-food-texture-both-loadings.png', type="png256", width=8, height=8, res=300, pointsize=14)
...
bitmap('pca-on-food-texture-pc1-scores.png', type="png256", width=8, height=4.5, res=300, pointsize=14)
par(cex.lab=1.0, cex.main=1.0, cex.sub=1.0, cex.axis=1.0)
...
# Plot the scores in sequence order
bitmap('pca-on-food-texture-pc2-scores.png', type="png256", width=8, height=4.5, res=300, pointsize=14)
par(cex.lab=1.5, cex.main=1.8, cex.sub=1.8, cex.axis=1.8)
par(mar=c(4.5, 4.2, 0.5, 0.5))  # (bottom, left, top, right); defaults are par(mar=c(5, 4, 4, 2) + 0.1)
...
# Joint score plot:
bitmap('pca-on-food-texture-both-scores.png', type="png256", width=8, height=8, res=300, pointsize=14)
par(cex.lab=1.5, cex.main=1.5, cex.sub=1.5, cex.axis=1.5)
par(mar=c(5.0, 4.2, 1.5, 0.5))  # (bottom, left, top, right); defaults are par(mar=c(5, 4, 4, 2) + 0.1)
...
bitmap('pca-on-food-texture-score-t1-contribution-for-obs-33.png', type="png256", width=10, height=4, res=300, pointsize=14)
...
system("ipython pca-on-food-texture-combine-plots.py")