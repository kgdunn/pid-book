...
bitmap('/Users/kevindunn/Statistics course/Course notes/Assignments/Assignment 3/images/normal-t-comparison.png', type="png256", width=12, height=7, res=300, pointsize=14) 
