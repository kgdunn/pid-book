bitmap('normal-distribution-standardized.png', type="png256", width=14, height=7, res=300, pointsize=14)
x <- seq(-3.8, 3.8, 0.01)
px <- dnorm(x)
plot(x, px, type="l", xlab=(expression(""*x)), ylab="p(x)", frame.plot=FALSE, main=(expression("Normal distribution when "*mu*"=0")), cex.lab=1.8, cex.main=1.8, lwd=2, cex.sub=1.8, cex.axis=1.8)
abline(v=0)
