...
A :index:`uniform distribution` arises when an observation's value is equally as likely to occur as all the other options of the recorded values. The classic example are dice: each face of a die is equally as likely to show up as any of the other faces. This forms a :index:`discrete, uniform distribution <single: uniform distribution; discrete>`.
