...
.. table:: :math:`R^2` of each block, as a percentage, per component, for every model on
   ...
   |                                         +----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+
   |                                         | :math:`t_1`    | :math:`t_2`    | :math:`t_1`    | :math:`t_2`    | :math:`t_1`    | :math:`t_2`    | :math:`t_1`    | :math:`t_2`    |
   +=========================================+================+================+================+================+================+================+================+================+
   | PCA on quality                          | -              | -              | -              | -              | -              | -              | 50.0           | 20.3           |
   +-----------------------------------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+
   | PLS from :math:`\mathbf{Z}_\text{chem}` | 28.8           | 23.2           | -              | -              | -              | -              | 16.3           | 5.8            |
   +-----------------------------------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+
   | PLS from :math:`\mathbf{Z}_\text{op}`   | -              | -              | 30.4           | 23.6           | -              | -              | 20.7           | 5.5            |
   +-----------------------------------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+
   | Multiblock PLS on :math:`\mathbf{Z}`    | 11.1           | 18.4           | 22.3           | 13.3           | -              | -              | 29.2           | 7.2            |
   +-----------------------------------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+
   | Batch PCA on :math:`\mathbf{X}`         | -              | -              | -              | -              | 23.1           | 14.6           | -              | -              |
   +-----------------------------------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+
   | Batch PLS on :math:`\mathbf{X}`         | -              | -              | -              | -              | 21.7           | 13.1           | 26.6           | 14.4           |
   +-----------------------------------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+
