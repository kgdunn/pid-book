...
.. answer::
	...
	#.	You could use the following code to plot the data:
		...
		.. figure:: ../figures/examples/room-temperature/assignment1-room-temperatures.jpg
			:alt:	../figures/examples/room-temperature/room-temperature-plots.R
			:scale: 60
			:width: 500px
			:align: center
		
		We did not expect you to plot time-based plots: a sequence plot was good enough.  There will be a tutorial later showing how to get a time-based :math:`x`-axis.
